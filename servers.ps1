...
#>
#Get the server list
$servers = Get-Content desktop\pc.txt
...
$infoColl | Export-Csv -path desktop\Server_Inventory_$((Get-Date).ToString('MM-dd-yyyy')).csv -NoTypeInformation #Export the results in csv file.